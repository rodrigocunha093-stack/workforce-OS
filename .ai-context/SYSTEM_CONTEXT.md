...
- **Painel Operacional** (aba Diagnóstico): faturamento dia/semana/mês, dimensionamento (1 colab/R$40k — `BENCH.fatPorFuncionario`, calibrável), pico de fluxo, perdas (ruptura/validade/abandono), multifuncionalidade, tendência, forecast 7 dias (sazonalidade), banco de horas. O **What-if** foi movido para a aba **Simulador** (2026-07-14) e usa a mesma régua `BENCH`.
